    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-6 col-md-4">
                ...
                <h5 class="my-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam, aspernatur alias. Soluta, explicabo reiciendis? Suscipit distinctio corporis molestiae maiores iste!</h5>
                <a href="#" class="btn btn-success my-3">Lihat Buku</a>
            </div>
            <div class="col-lg-6 col-md-4">
